...
@implementation PlayViewTransitionAnimator
...
- (void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext
{
  ...
  //  toView.frame = _startFrame;//[transitionContext finalFrameForViewController:toViewController];
